...
async function verifyPayment(req, res) {
  try {
    ...
    const monthStr = invoice.billingMonth ? `${invoice.billingMonth}/${invoice.billingYear}` : 'hiện tại';
    await notificationService.createPersonalNotification(req.uid, {
      title: 'Thanh toán thành công',
      message: `Bạn đã thanh toán thành công hóa đơn phí vệ sinh môi trường tháng ${monthStr}. Mã giao dịch: PAYOS_${invoice.invoiceId}.`,
      type: 'payment'
    });
